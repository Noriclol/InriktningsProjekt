Shader "Custom/DistortionFlowTransparent"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "Assets/Scripts/Shaders/Include/LookingThroughWater.cginc"
        ...
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            ...
            //setting waterfogcolor to color
            _WaterFogColor = _Color;
