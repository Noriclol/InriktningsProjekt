...
public class TestBuoySine : MonoBehaviour
{
    //Vector3 startPos;
    Vector3 startPos;
    ...
    void Update()
    {
        ...
        gameObject.transform.position = new Vector3(transform.position.x, WaveHandler.instance.GetWaveYPos(startPos, GameManager.secondsSinceStart), transform.position.z);//WaveHandler.instance.CustomWaveFunc2(startPos, GameManager.secondsSinceStart); //aproximated height of xy
